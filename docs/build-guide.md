...
| `ANDROID_RELEASE_KEYSTORE_PASSWORD` | Android keystore store password |
| `ANDROID_RELEASE_KEY_PASSWORD` | Android key-entry password (optional; defaults to `ANDROID_RELEASE_KEYSTORE_PASSWORD` when omitted) |
