...
#
# Prerequisites:
#   - $GODOT4 points to Godot 4.4 (Mono/C#) headless binary
...
if [ -d "$BUILD_DIR/gradle" ]; then
  ...
  SIGNED_APK="$DIST_DIR/CorditeWars_0.1.0.apk"
  ...
  if [ -f "$BUILD_DIR/CorditeWars.apk" ]; then
    cp "$BUILD_DIR/CorditeWars.apk" "$DIST_DIR/CorditeWars_0.1.0_unsigned.apk"
